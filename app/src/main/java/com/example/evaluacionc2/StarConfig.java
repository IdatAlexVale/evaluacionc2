...
public class StarConfig extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.configuracion_fragment,container,false);
    ...
    public void onPause(){
        super.onPause();
        Glide.with(StarConfig.this).load(imageUri).into(set);
    ...
    private void uploadProfileCoverPhoto(final Uri uri) {
        ...
        pd.dismiss();
        Toast.makeText(StarConfig.this.getContext(), "Updated Photo", Toast.LENGTH_LONG).show();
    }
